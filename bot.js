...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/onetoughleague/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://daddyleagues.com/onetoughleague/rules");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/onetoughleague/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/onetoughleague/players?name="+rep+"&position=all&team=all");
      this.res.end();
  }          
